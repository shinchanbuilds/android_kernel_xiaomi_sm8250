...
if [ -d "anykernel/.git" ]; then
    ...
    make $MAKE_ARGS vendor/kona-perf_defconfig vendor/xiaomi/bloodreaper.config vendor/debugfs.config vendor/xiaomi/sm8250-common.config vendor/xiaomi/pipa.config
    ...
    cd anykernel
    ZIP_FILENAME=Kernel_BloodReaper_pipa_AOSP_${GIT_COMMIT_ID}.zip
